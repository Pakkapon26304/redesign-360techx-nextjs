...
export default function ContactTestimonialSection() {
  return (
    <section className="testimonial-section reveal" style={{ maxWidth: '1200px', margin: '0 auto', padding: '4rem 2rem' }}>
        <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '2.2rem', marginBottom: '0.5rem' }}>เสียงตอบรับจาก<span className="text-gradient">ผู้ใช้งานจริง</span></h2>
            <p style={{ fontSize: '1.1rem', opacity: '0.8' }}>ความไว้วางใจจากพาร์ทเนอร์และลูกค้าของเรา</p>
        </div>
