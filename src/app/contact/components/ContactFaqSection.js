...
export default function ContactFaqSection() {
  return (
    <section className="faq-section reveal" style={{ maxWidth: '1000px', margin: '0 auto', padding: '2rem 2rem 5rem 2rem' }}>
        <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '2.2rem', marginBottom: '0.5rem' }}>คำถามที่<span className="text-gradient">พบบ่อย</span> (FAQ)</h2>
        </div>
        ...
        <div className="faq-container">
            <details className="faq-item">
                ...
                <div className="faq-answer">
                    <p>เราได้นำประสบการณ์การบริหารการขนส่งบน Platform 360TRUCK มาออกแบบ<a href="https://www.360techx.co/tms/" target="_blank" style={{ color: 'var(--primary-color)', textDecoration: 'underline' }}>ระบบ TMS</a> ของ 360TECHX โดยมีจุดเด่น คือ รองรับการใช้งานร่วมกับ 360TRUCK, ใช้งานง่าย และสามารถใช้งาน 360TRUCKER แอปพลิเคชัน สำหรับคนขับรถใช้รายงานสถานะขนส่งได้ไม่จำกัด</p>
                </div>
            </details>
            ...
            <details className="faq-item">
                ...
                <div className="faq-answer">
                    <p>สามารถทดลองใช้งานได้ฟรี ผ่านทาง <a href="https://tms.360techx.co/signup" target="_blank" style={{ color: 'var(--primary-color)', textDecoration: 'underline' }}>https://tms.360techx.co/signup</a></p>
                </div>
            </details>
        </div>
    </section>
